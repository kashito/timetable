...
<!doctype html>
<html lang="ja">
<head><script src="staff-auth.js?v=20260917-r56-ready" data-staff="required"></script><script src="workspace-ui.js?v=20260916-r54-ready"></script><script src="lesson-groups.js?v=20260916-r53"></script><script src="history-window.js?v=20260915-r50"></script>
<meta charset="utf-8">
...
<main>
<div class="confirmed-date-bar">確定日 <input id="scheduleConfirmedDate" type="date"><span id="scheduleConfirmedStatus" class="confirmed-date-status"></span></div>
...
(function(){
  ...
  function start(){draw();setInterval(draw,15000);window.addEventListener('resize',draw);const root=document.getElementById('grid')||document.body;const obs=new MutationObserver(()=>{clearTimeout(window.__generatorTodayLineTimer);window.__generatorTodayLineTimer=setTimeout(draw,80)});obs.observe(root,{childList:true,subtree:true});}
