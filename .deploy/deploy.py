...
REMOTE_PYTHON = ('if [ -x /usr/local/bin/python3 ]; then exec /usr/local/bin/python3 -; '
                 'elif [ -x /usr/bin/python3 ]; then exec /usr/bin/python3 -; '
                 'else echo "python3 unavailable" >&2; exit 127; fi')
